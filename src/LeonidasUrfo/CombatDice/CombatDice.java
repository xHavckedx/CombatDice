...
public class CombatDice extends JavaPlugin {
	...
	public void onEnable() {
		Bukkit.getConsoleSender()
				.sendMessage(nombre + ChatColor.WHITE + " Cargando el plugin CombatDice en la versión " + version);
	...
	public void onDisable() {
		Bukkit.getConsoleSender()
				.sendMessage(nombre + ChatColor.WHITE + " Desactivando el plugin CombatDice en la versión " + version);
	}
