	...
	public void onCommand(CommandSender sender, Command comando, String label, String[] args) {
		...
		if( jugadorArray.get(intJugador1).isMiTurno()) {
			if(args[1].equals("fuerza") || args[1].equals("f")) {
				...
				Bukkit.broadcastMessage( ChatColor.BOLD + jugadorArray.get(intJugador1).getNombre() + " ha tirado un " + ChatColor.RED + tiradaJugador1 + ChatColor.BOLD + " + (" + jugadorArray.get(intJugador1).getFuerza() + ") " + ChatColor.RED + tiradaJugador1Final );
				...
				Bukkit.broadcastMessage( ChatColor.BOLD + jugadorArray.get(intJugador1).getNombre() + " ha tirado un " + ChatColor.RED + tiradaJugador1 + ChatColor.BOLD + " + (" + jugadorArray.get(intJugador1).getDestreza() + ") " + ChatColor.RED + tiradaJugador1Final );
				jugadorArray.get(intJugador1).setNumeroAtaque(tiradaJugador1Final);
				jugadorArray.get(intJugador1).setMiTurno(false);
